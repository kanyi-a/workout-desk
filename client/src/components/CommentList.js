...
export default function CommentList({ user }) {
  ...
  return (
    ...
    <div className="comment-page-intro">
      <p>Join others in sharing your experiences on this platform.<br/>Whether stretching is something you have never tried before, or an important habit in your everyday life,<br/> take a break from the stranious hours at your desk and stretch out.</p>
    </div>
